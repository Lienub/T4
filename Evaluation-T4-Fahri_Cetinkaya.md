...
- Ajout de plus de possiblités de fin (exemple : mort brulé, honorer par le roi suite à une action héroïque...)
- Configuration des touches du jeu plus adapté afin que le jeu soit plus plaisant à jouer
- Menu pour mieux représenter le jeu ainsi que le paramètre
- Animation pour un jeu plus plaisant (exemples : feuilles des arbres qui bougent, l'animation du personnage et des PNJ visible...)
- Faire en sorte que le jeu s'adapte à n'importe quel taille de la fenêtre
...
Justifications : Pas de difficulté concernant GIT, tout est bien représenté.
...
Justifications : L'installation se fait facile même si il fallait cliquer sur plusieurs répertoires pour accéder à l'application mais en tout cas, tout est impeccable.
...
Justifications : Le cahier des charges est bien modélisé dans le sens où la représentation du jeu et l'explication est présente sauf dans la partie Scénario, j'ai l'impression qu'il dévoile toutes les réponses, c'est bien si on est bloqué car elle nous permet de se débloquer mais mal pour quelqu'un qui a tous lu car on sait déjà quel choix utilisé.
...
Justifications : Les fonctionnalités ne couvrent pas toutes comme c'est le cas pour la fonctionnalité Recommencer. Et je ne vois pas d'où les fonctionnalités sont annotées par une difficulté, peut-être que j'ai tort...
...
Justifications : Les scénarios avec WIN, NUL, LOSE ont été bien représenté sauf que ça manque de plus de fin. Pour les scénarios additionnels, perso je n'ai pas eu ces événements additionnels quand j'ai testé mais j'ai l'impression qu'ils n'ont pas été mis.

## Résultat T4
- Total d'item « Excellent » (2 point) : 11
- Total d'item « Satisfaisant » (1 point) : 13
