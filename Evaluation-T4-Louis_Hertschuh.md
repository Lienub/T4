...
- Le jeu en plein écran est buggué, il est collé en haut à a droite
- Une fin dans laquelle on peut devenir prince du royaume en épousant la fille du roi
- Mettre un menu ( surtout pour indiquer les touches )
- Les PNJs avec les quelles on ne peut plus interragire, mettre un dialogue différent au lieu de reproposer le choix 
- Modifier les collisions sur la map ( ne pas pouvoir traverser les arbres dans sc.2 et 3, ni même se téléporter de gauche à droite en sortant de la carte
- Les morts abruptes sont vraiment trop abruptes, ça frustre on peut perdre dans notre lancée en un dialogue 
- Mettre plus en évidence l'argent et l'age en haut à gauche
...
Justifications :
Le git était très bien organisé, le seul petit problème a été réglé au début ( mauvaise branche )
...
Justifications :
Le jeu s'installe et se lance très bien, les seuls points modifiable sont:
	-Des instructions à donner pour le joueur ( les touches ne sont pas indiquée )
	-Le plein écran n'est pas bien fait, le jeu se colle en haut à gauche 
...
Justifications : 
Le cahier des charges étaient bien fait, 7 pages complètes. Un peu plus de précision sur certaines fonctionnalités auraient été le bien venu
...
Justifications : 
Les fonctionnalités étaient ce qui devait etre détaillé plus en détail dans le cahier des charges, par exemple soit dire des fonctionnalités basiques ( Se déplacer ), soit plus détailler certaines autres .
De plus les fonctionnalités ne sont pas annotés par difficultés 
...
Justifications :
On a un scénario principal ( qui nous demande de changer de classe sociale) et on a 3 fins pour soit, soit on perds en mourrant, soit on devient religieux ou alors on gagne en devenant noble.
Il est présenté dans la page d'acceuil et les fins sont débloquées en fonctions de nos actions dans le jeu
